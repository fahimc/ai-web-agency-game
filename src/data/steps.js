export const previewSteps = [
  ...
  },
  {
    ...
    task: 'Create the final design direction for a high-converting responsive website using the selected design direction, colour palette, pages, sections, and Bootstrap 5.3 + MicroAgency Layout Engine. Think in this architecture: Page -> Sections -> Layouts -> Components -> Content. Include layout primitive choices, section order, visual style, typography feel, UX notes, microcopy guidance, accessibility notes and mobile-first considerations. Require a Bootstrap responsive navbar with a visible hamburger toggler on mobile. Treat the selected pages and sections as client-approved unless the brief makes one impossible.',
  },
  {
    key: 'WebsiteHTML',
    employee: 'dev',
