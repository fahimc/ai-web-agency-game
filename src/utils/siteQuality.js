...
const BAD_FINAL_SITE_LANGUAGE = [
  ...
  /\bpage objective\b/i,
  /\bvisitor intent\b/i,
  /\bcontent block\s+\d+\b/i,
  /\bhero support copy\b/i,
  /\btrust and proof\b/i,
  /\bprimary cta\b/i,
  /\b(header with cta|hero split|services grid|features bento|portfolio grid|contact form|about story|lead capture form)\b/i,
  /\blead with\b/i,
  /\bexplain what\b/i,
  /\bexplain how\b/i,
