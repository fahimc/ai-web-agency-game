...
export function useAgencyController() {
  ...
  const update = useCallback((updater, persist = true) => {
    ...
    if (persist) {
      ...
      selectedTemplateId: saved.selectedTemplateId || next.selectedTemplateId,
      selectedLogoConfig: saved.selectedLogoConfig || next.selectedLogoConfig,
  ...
  const loadProject = useCallback((email, projectId) => {
    ...
    const next = normalizeRestoredUiState({
      ...
      selectedTemplateId: loaded.selectedTemplateId || '',
      selectedLogoConfig: loaded.selectedLogoConfig || null,
  ...
  const selectDesignStyle = useCallback((layoutId, palette = [], structure = {}) => {
    ...
    update((current) => ({
      ...
      selectedTemplateId: structure.recommendation?.baseTemplateId || '',
      selectedLogoConfig: structure.recommendation?.logo || null,
